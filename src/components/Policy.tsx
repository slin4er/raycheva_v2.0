			...
			<Container>
				<PolicyBlock>
					...
					<P>
						...
						Райчевым Андреем Игоревичем (далее – Оператор).
					</P>
					<UL>
						<li>
					...
					<UL>
						...
						<li>
							...
							их доступность в сети интернет по сетевому адресу raycheva.org.
						</li>
						<li>
						...
						<li>
							2.10. Пользователь – любой посетитель веб-сайта raycheva.org.
						</li>
						<li>
					...
					<UL>
						<li>
							...
							материалам, содержащимся на веб-сайте raycheva.org;
							<br />– уточнение деталей заказа.
						</li>
						<li>
							...
							адрес электронной почты policyraycheva@gmail.com с пометкой «Отказ
					...
					<UL>
						...
						<li>
							...
							через специальные формы, расположенные на сайте raycheva.org или
					...
					<UL>
						...
						<li>
							...
							Оператора policyraycheva@gmail.com с пометкой «Актуализация
							персональных данных».
						</li>
						<li>
							...
							policyraycheva@gmail.com с пометкой «Отзыв согласия на обработку
							персональных данных».
						</li>
						<li>
					...
					<UL>
						...
						<li>
							...
							сети Интернет по адресу raycheva.org/policy.
						</li>
					</UL>
				</PolicyBlock>
			</Container>
